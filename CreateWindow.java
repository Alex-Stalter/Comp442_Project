...
public class CreateWindow extends JFrame implements ActionListener {
    ...
    private void setManagerPane(){
        ...
        constraints.gridx = 0;
        constraints.gridy = 1;
        managerPane.add(cleanerRatio,constraints);

        constraints.gridx = 0;
        constraints.gridy = 2;
        managerPane.add(maintRatio,constraints);
        ...
        constraints.gridx = 1;
        constraints.gridy = 1;
        managerPane.add(hireCleaner, constraints);

        constraints.gridx = 1;
        constraints.gridy = 2;
        managerPane.add(hireMaint, constraints);

        constraints.gridx = 2;
        constraints.gridy = 1;
        managerPane.add(fireCleaner, constraints);

        constraints.gridx = 2;
        constraints.gridy = 2;
        managerPane.add(fireMaint, constraints);

        constraints.gridx = 3;
        constraints.gridy = 1;
        managerPane.add(weeklyCost, constraints);

        constraints.gridx = 3;
        constraints.gridy = 2;
        managerPane.add(weeklyIncome, constraints);

        constraints.gridx = 3;
        constraints.gridy = 3;
        managerPane.add(weeklyNet, constraints);
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        }else if(textUsername.getText().equals("Manager")&&password.toString().equals("manager")&&e.getSource()==buttonLogin){
            currentPane.setVisible(false);
            setManagerPane();
            add(managerPane);
            currentPane = managerPane;
